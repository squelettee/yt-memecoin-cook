  ...
  return (
    <div className="flex flex-col h-full min-w-[320px]">
      <Tabs
        ...
        className="w-full md:w-[320px] border-r flex flex-col h-full"
      >
        {/* Fixed Header */}
      ...
      <div className="w-full md:w-[320px] border-r px-4 py-4 border-t bg-background">
