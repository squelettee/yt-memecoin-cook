              ...
              >
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                    ...
                    <span
                      className="flex-shrink-0 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full text-white font-bold text-base sm:text-lg"
                      style={{
                    ...
                    <span
                      className="font-bold text-base sm:text-lg break-words min-w-0 overflow-hidden text-ellipsis"
                  ...
                  {/* Flèche responsive */}
                  <ChevronDown
                    className={`flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 ml-2 transition-transform ${
