    ...
    <div className="space-y-8 px-6 flex flex-col items-center">
      ...
      <div className="grid gap-6 md:grid-cols-3 max-w-5xl w-full">
        <div className="p-6 rounded-lg border bg-card flex flex-col items-center text-center h-full">
          ...
          <Image src="https://memecook.fun/assets/phantom-how-to-buy.jpeg" alt="phantom" width={50} height={50} className="rounded-md mt-4" />
        </div>
        ...
        <div className="p-6 rounded-lg border bg-card flex flex-col items-center text-center h-full">
          ...
          <Image src="https://memecook.fun/assets/solana-how-to-buy.jpeg" alt="solana" width={50} height={50} className="rounded-md mt-4" />
        </div>
        ...
        <div className="p-6 rounded-lg border bg-card flex flex-col items-center text-center h-full">
          ...
          <Image src="https://memecook.fun/assets/jupiter-how-to-buy.jpeg" alt="jupiter" width={50} height={50} className="rounded-md mt-4" />
        </div>
      </div>
    </div>
  );
