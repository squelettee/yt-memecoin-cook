...
CREATE TABLE "Template" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "type" VARCHAR(255) NOT NULL DEFAULT 'beta',
    ...
    "tiktok" VARCHAR(255),
    "twitter" VARCHAR(255),
    "headingFont" VARCHAR(255) NOT NULL DEFAULT 'outfit',
    "bodyFont" VARCHAR(255) NOT NULL DEFAULT 'outfit',
    ...
    "aboutUsTitle" VARCHAR(255),
    "aboutUsContent" VARCHAR(255),
    "aboutUsImage" VARCHAR(255),
